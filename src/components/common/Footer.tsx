        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/properties?status=temporary_rent" className="text-gray-300 hover:text-primary transition-colors">Alquiler temporario</Link>
              </li>
              <li>
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">Av. Presidente Illia 256, San Luis, Argentina</span>
              </li>
              <li className="flex items-center">
                <Clock className="h-5 w-5 mr-3 text-primary flex-shrink-0" />
                <span className="text-gray-300">Lun - Vie: 9:00 - 18:00<br />Sáb: 9:00 - 13:00</span>
              </li>
              <li className="flex items-center">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:info@karttem.com" className="text-gray-300 hover:text-primary transition-colors">
                  info@karttem.com
                </a>
              </li>
            </ul>
