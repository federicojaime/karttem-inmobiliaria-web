        ...
        >
          <div className="bg-white p-4 rounded-xl shadow-xl">
            <div className="h-96 bg-gray-200 rounded-lg overflow-hidden">
              {/* Aquí iría el componente de mapa real. Por ahora colocamos un placeholder */}
              <div className="h-full w-full flex items-center justify-center bg-gray-300">
                <div className="text-center">
                  <MapPin className="h-12 w-12 text-amber-500 mx-auto mb-4" />
                  <p className="text-gray-700 font-medium">Mapa de ubicación de KARTTEM Inmobiliaria</p>
                  <p className="text-gray-500 text-sm">(Aquí se integraría Google Maps o similar)</p>
                </div>
              </div>
            </div>
          </div>
